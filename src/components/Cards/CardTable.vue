        ...
        <tbody>
          <tr>
            <th
              ...
              <img :src="bootstrap" class="w-12 h-12 bg-white border rounded-full" alt="..." />
            ...
            <td class="p-4 px-6 text-xs align-middle border-t-0 border-l-0 border-r-0 whitespace-nowrap">
              <div class="flex">
                <img :src="team1" alt="..." class="w-10 h-10 border-2 rounded-full shadow border-blueGray-50" />
                <img :src="team2" alt="..." class="w-10 h-10 -ml-4 border-2 rounded-full shadow border-blueGray-50" />
                <img :src="team3" alt="..." class="w-10 h-10 -ml-4 border-2 rounded-full shadow border-blueGray-50" />
                <img :src="team4" alt="..." class="w-10 h-10 -ml-4 border-2 rounded-full shadow border-blueGray-50" />
              </div>
            </td>
            <td class="p-4 px-6 text-xs align-middle border-t-0 border-l-0 border-r-0 whitespace-nowrap">
          ...
          <tr>
            <th
              class="flex items-center p-4 px-6 text-xs text-left align-middle border-t-0 border-l-0 border-r-0 whitespace-nowrap">
              <img :src="angular" class="w-12 h-12 bg-white border rounded-full" alt="..." />
              <span class="ml-3 font-bold" :class="[
                color === 'light' ? 'text-blueGray-600' : 'text-white',
              ]">
          ...
          <tr>
            <th
              class="flex items-center p-4 px-6 text-xs text-left align-middle border-t-0 border-l-0 border-r-0 whitespace-nowrap">
              <img :src="sketch" class="w-12 h-12 bg-white border rounded-full" alt="..." />
              <span class="ml-3 font-bold" :class="[
                color === 'light' ? 'text-blueGray-600' : 'text-white',
              ]">
            ...
            <td class="p-4 px-6 text-xs align-middle border-t-0 border-l-0 border-r-0 whitespace-nowrap">
              <i class="mr-2 text-red-500 fas fa-circle"></i> delayed
            </td>
            <td class="p-4 px-6 text-xs align-middle border-t-0 border-l-0 border-r-0 whitespace-nowrap">
              <div class="flex">
                <img :src="team1" alt="..." class="w-10 h-10 border-2 rounded-full shadow border-blueGray-50" />
          ...
          <tr>
            <th
              class="flex items-center p-4 px-6 text-xs text-left align-middle border-t-0 border-l-0 border-r-0 whitespace-nowrap">
              <img :src="react" class="w-12 h-12 bg-white border rounded-full" alt="..." />
              <span class="ml-3 font-bold" :class="[
                color === 'light' ? 'text-blueGray-600' : 'text-white',
              ]">
            ...
            <td class="p-4 px-6 text-xs align-middle border-t-0 border-l-0 border-r-0 whitespace-nowrap">
              <i class="mr-2 text-teal-500 fas fa-circle"></i> on schedule
            </td>
            <td class="p-4 px-6 text-xs align-middle border-t-0 border-l-0 border-r-0 whitespace-nowrap">
              <div class="flex">
                <img :src="team1" alt="..." class="w-10 h-10 border-2 rounded-full shadow border-blueGray-50" />
          ...
          <tr>
            <th
              class="flex items-center p-4 px-6 text-xs text-left align-middle border-t-0 border-l-0 border-r-0 whitespace-nowrap">
              <img :src="vue" class="w-12 h-12 bg-white border rounded-full" alt="..." />
              <span class="ml-3 font-bold" :class="[
                color === 'light' ? 'text-blueGray-600' : 'text-white',
              ]">
                React Material Dashboard
